...
class ProfissionalFragment(var profissionais:List<Profissional>) : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_profissional_list, container, false)
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = ProfissionalAdapter(profissionais, listener)
            }
        }
        return view
    }
    ...
    interface OnListFragmentInteractionListener {
        ...
        fun onListFragmentInteraction(item: Profissional?)
    }
    ...
    companion object {
        ...
        fun newInstance(columnCount: Int) =
            ProfissionalFragment(listOf<Profissional>()).apply {
