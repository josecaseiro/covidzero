 ...
 * Use the [PerguntasContactoFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class PerguntasContactoFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment PerguntasContactoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            PerguntasContactoFragment().apply {
